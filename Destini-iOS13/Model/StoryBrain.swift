...
struct StoryBrain {
    ...
    mutating func nextStory(choice destination: String) {
        currentStory = destination == "choice1" ? stories[currentStory.choice1Destination] : stories[currentStory.choice2Destination]
    }
}
